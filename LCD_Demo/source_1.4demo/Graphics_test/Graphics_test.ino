...
unsigned long testFillScreen() {
  ...
  tft.fillScreen(ST7789_RED);  delay(500);
  tft.fillScreen(ST7789_GREEN); delay(500);
  tft.fillScreen(ST7789_BLUE); delay(500);
  tft.fillScreen(ST7789_WHITE); delay(500);
  tft.fillScreen(ST7789_CYAN); delay(500);
  tft.fillScreen(ST7789_YELLOW); delay(500);
...
unsigned long testText() {
  ...
  tft.println(0xDEADBE, HEX);
   tft.setTextColor(ST7789_GREEN); tft.setTextSize(1);
  tft.println("www.buydisplay.com");
   tft.setTextColor(ST7789_CYAN); tft.setTextSize(2);
